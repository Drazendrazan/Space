...
Config.Text = {
	SitOnChair = '~r~G~w~ Pour vous asseoir',
	SitOnBed = '~r~E~w~ Pour vous asseoir sur le lit',
	LieOnBed = '~r~E~w~ to Pour vous allonger sur le lit',
	SwitchBetween = 'Changer entre avec ~r~Arrow left~w~ et ~r~arrow right~w~',
	Standup = '~r~F~w~ to vous levez',
}